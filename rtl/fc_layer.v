...
module fc_layer #(
    ...
    // Pipeline Registers for MAC and 2-cycle Latency
    reg signed [ACC_WIDTH-1:0] mul_res_reg;
    reg                        mul_valid_reg;
    reg                        feature_valid_d1;
    reg signed [FEATURE_WIDTH-1:0] feature_in_d1;
        ...
        if (!rst_n) begin
            ...
            case (state)
                ...
                COMPUTE: begin
                    ...
                    // 2-cycle latency compensation
                    feature_valid_d1 <= feature_valid;
                    feature_in_d1    <= feature_in;
                    ...
                    if (feature_valid_d1) begin
                        mul_res_reg <= ({{(ACC_WIDTH-FEATURE_WIDTH){feature_in_d1[FEATURE_WIDTH-1]}}, feature_in_d1} *
